...
def viewImage(imgID):
    try:
        ...
        #imgName, imageData = cursor.fetchone()
        ...
        if imageData:
            ...
            #return sendfile(imgByteArray, mimetype=f'image/image.format.lower()')
            #return render_template('viewImage.html', imageData=imageData, mimeType=mimeType)
        else:
